...
import { Calendar, DollarSign, PieChart, Briefcase, Plus, FileText, Download, CheckCircle, Clock, AlertTriangle, X, User as UserIcon, AlertCircle, Edit2, Check, Paperclip, FolderOpen, ArrowRight, ExternalLink, Watch } from 'lucide-react';
...
import { RosterCalendar } from '../components/hr/RosterCalendar';

type HRTab = 'leave' | 'attendance' | 'payroll' | 'management' | 'docs';
  ...
  return (
    <div className="flex flex-col h-full space-y-4">
        ...
        <div className="flex border-b border-slate-200">
            ...
            <TabButton id="attendance" label="考勤排班 (Roster)" icon={<Watch size={18}/>} active={activeTab} onClick={setActiveTab} />
        ...
        <div className="flex-1 overflow-y-auto p-2">
            ...
            {/* Tab 1.5: Attendance & Roster (Module C Extension) */}
            {activeTab === 'attendance' && (
                <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                            <h4 className="font-bold text-slate-800 mb-4 flex items-center gap-2">
                                <AlertTriangle size={18} className="text-orange-500"/> 異常考勤提醒
                            </h4>
                            <div className="space-y-3">
                                <div className="p-3 bg-red-50 text-red-700 text-sm rounded-lg flex items-center gap-2">
                                    <X size={14} /> 2025-01-15 曠職 (Absent)
                                </div>
                                <div className="p-3 bg-orange-50 text-orange-700 text-sm rounded-lg flex items-center gap-2">
                                    <AlertCircle size={14} /> 2025-01-18 遲到 (Late) - 15m
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-2 h-[600px]">
                        <RosterCalendar users={MOCK_USERS} />
                    </div>
                </div>
            )}
